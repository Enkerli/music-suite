...
import { applySubstitutions, assertDegree, chordScaleFor, parseLeadsheet, realizeChord, spellRoot } from "@enkerli/theory";
...
export default function App() {
  ...
  const genId = `${tonic}|${mode}|${seed}|${bars}|${harmonicRhythm}|${temperature}|${method}|${startFrom}|${variety}|${reharm}|${opCount}`;
  ...
  const genIdFor = (op, o = {}) =>
    `${o.tonic ?? tonic}|${o.mode ?? mode}|${seed}|${bars}|${harmonicRhythm}|${temperature}|${method}|${startFrom}|${variety}|${reharm}|${op}`;
  ...
  function currentPatch() {
    return { tonic, mode, bars, harmonicRhythm, temperature, variety, reharm, method, startFrom, voicingShape, voiceLeadMode, channelMode };
  }

...
export default function ConcentricPCSPickerV2() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4">
      <div className="mx-auto max-w-6xl rounded-[28px] border border-slate-300 bg-white p-3 shadow-sm">
        <div className="overflow-hidden rounded-[24px] bg-[radial-gradient(circle_at_center,_white,_#edf2f7)]">

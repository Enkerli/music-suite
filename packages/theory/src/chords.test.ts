...
describe('binaryToDecimal', () => {
  it('reads a 12-bit string as a plain MSB numeral (generic helper)', () => {
...
describe('pcsToDecimal (leftmost = LSB: pc i contributes 2^i)', () => {
  it('C major triad {0,4,7} → 145 (0x91)', () => {
...
describe('getAllQualities', () => {
  it('returns all 172 qualities', () => {
    expect(getAllQualities().length).toBe(172);
  });
...
describe('dictionarySize', () => {
  it('returns 172', () => {
    expect(dictionarySize()).toBe(172);
  });
});
